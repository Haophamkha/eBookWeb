        ...
        {products.length > 0 ? (
          products.map((item, index) => (
            ...
            >
              ...
              <div className="absolute bottom-[-20px] left-1/2 transform -translate-x-1/2 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <CustomButton width="200px" bgColor="#f97316" onClick={(e) => addToCart(item, e)}/>
            </div>
            </Link>
          ))
        ) : (
